...
Library    Collections
Library    DataDriver       file=resources/dataum1.csv
...
*** Test Cases ***
Login with user ${username} and password ${password}        XYZ     123gidgdg
*** Keywords ***
...
Fill the login form
    ...
    Wait Until Element Is Enabled       xpath://button[@type='submit']      10
